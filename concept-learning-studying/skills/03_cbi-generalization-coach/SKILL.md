...
# 진행
1) 개념/기능 추출 및 확정(정답X, 후보 제시 → 사용자 승인 후 확정)
- 핵심 개념(core_concepts) 1~2
- 관련 개념(related_concepts) 3~6
- 기능(skills/functions) 2~4
- 개념적 렌즈(conceptual lens) 2~3 최종 선택
- Key Concept 후보 2~3 (예: 인과/기능/책임/변화/연결 등)
- 필수 게이트: 위 항목이 확정되기 전에는 일반화 문장 작성 단계로 넘어가지 않는다.
